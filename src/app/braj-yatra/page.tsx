  ...
  useEffect(() => {
    const fetchTourData = async () => {
      try {
        ...
        // Get all Braj Yatra tours
        const brajYatraTours = result.data.filter((trip: any) => 
          trip.title.includes('Braj Yatra') || 
          (trip.title.includes('Mathura') && trip.title.includes('Vrindavan'))
        );
        
        // Sort by date
        brajYatraTours.sort((a: any, b: any) => 
          new Date(a.departureDate).getTime() - new Date(b.departureDate).getTime()
        );
        
        setAvailableDates(brajYatraTours);
        
        // Set the first tour as default
        if (brajYatraTours.length > 0) {
          setTourData(brajYatraTours[0]);
          setSelectedDate(brajYatraTours[0].id);
        }
        
        console.log('Braj Yatra tours found:', brajYatraTours);
      } catch (error) {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="mt-4 space-y-2">
            <Link href="/" className="text-purple-600 hover:text-purple-700 block">
              ← Back to Home
            </Link>
            <Link href="/premium-combo" className="text-purple-600 hover:text-purple-700 block">
              View All Tours →
            </Link>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">Krishna Janmabhoomi</h3>
                        <p className="text-sm text-gray-600">Birth place of Lord Krishna in Mathura</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="bg-purple-100 rounded-lg p-2 mt-1">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">Banke Bihari Temple</h3>
                        <p className="text-sm text-gray-600">Most revered Krishna temple in Vrindavan</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="bg-purple-100 rounded-lg p-2 mt-1">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">Taj Mahal</h3>
                        <p className="text-sm text-gray-600">Wonder of the world in Agra</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="bg-purple-100 rounded-lg p-2 mt-1">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">Prasad Meals</h3>
                        <p className="text-sm text-gray-600">Authentic Braj region cuisine</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-600 mt-0.5" />
                      <div>
                        <h3 className="font-semibold text-gray-900">Divine Experience</h3>
                        <p className="text-sm text-gray-600">Visit Krishna's land and the magnificent Taj Mahal</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-600 mt-0.5" />
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Luxury AC semi-sleeper buses with experienced drivers</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-600 mt-0.5" />
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                  <div className="text-center mb-6">
                    <div className="text-3xl font-bold text-purple-600">₹{tourData?.pricePerSeat || 1800}</div>
                        ...
                        {availableDates.map((tour) => (
                          <option key={tour.id} value={tour.id}>
                            {new Date(tour.departureDate).toLocaleDateString('en-IN', {
                              ...
                              month: 'short',
                              year: 'numeric'
                            })} - {tour.availableSeats} seats available - ₹{tour.pricePerSeat}
                          </option>
                        ))}
                      </select>
                    </div>
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>Luxury AC Bus Transportation</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                        <Check className="w-4 h-4 text-green-600" />
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-8">
                ...
                <div className="relative">
                  <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-purple-200 ml-4"></div>
                  
                  <div className="relative flex items-start gap-4">
                    <div className="bg-purple-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-semibold z-10">
                      1
                    </div>
                    <div className="flex-1">
                      <div className="bg-purple-50 rounded-lg p-4">
                        ...
                        <div className="space-y-2 text-sm text-gray-600">
                          ...
                          <div className="flex items-center gap-2">
                            <Bus className="w-4 h-4" />
                            <span>Overnight journey in luxury AC bus</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="bg-purple-50 rounded-lg p-4">
                        <h3 className="font-semibold text-gray-900 mb-2">Sunday Early Morning - Mathura</h3>
                        <div className="space-y-2 text-sm text-gray-600">
                          <div className="flex items-center gap-2">
                            <Clock className="w-4 h-4" />
                            <span>4:00 AM - 7:00 AM - Krishna Janmabhoomi Darshan</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <MapPin className="w-4 h-4" />
                            <span>Krishna Janmabhoomi Temple, Mathura</span>
                          </div>
                          <div className="flex items-center gap-2">
                ...
                {/* Day 2 - Sunday Morning Vrindavan */}
                <div className="relative">
                  <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-purple-200 ml-4"></div>
                  ...
                  <div className="relative flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="bg-purple-50 rounded-lg p-4">
                        <h3 className="font-semibold text-gray-900 mb-2">Sunday Morning - Vrindavan</h3>
                        <div className="space-y-2 text-sm text-gray-600">
                          <div className="flex items-center gap-2">
                            <Clock className="w-4 h-4" />
                            <span>8:00 AM - 12:00 PM - Vrindavan Temple Tour</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <MapPin className="w-4 h-4" />
                            <span>Banke Bihari, Prem Mandir, ISKCON Temple</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Camera className="w-4 h-4" />
                            <span>Photography and shopping time</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="bg-purple-50 rounded-lg p-4">
                        <h3 className="font-semibold text-gray-900 mb-2">Sunday Afternoon - Agra</h3>
                        <div className="space-y-2 text-sm text-gray-600">
                          <div className="flex items-center gap-2">
                            <Clock className="w-4 h-4" />
                            <span>2:00 PM - 6:00 PM - Taj Mahal Visit</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <MapPin className="w-4 h-4" />
                            <span>Taj Mahal, Agra Fort</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Utensils className="w-4 h-4" />
                            <span>Lunch at Agra's famous restaurant</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-1">
                      <div className="bg-purple-50 rounded-lg p-4">
                        ...
                        <div className="space-y-2 text-sm text-gray-600">
                          <div className="flex items-center gap-2">
                            <Clock className="w-4 h-4" />
                            <span>8:00 PM - Departure from Agra</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Bus className="w-4 h-4" />
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Luxury AC Bus Transportation</h4>
                      <p className="text-sm text-gray-600">Comfortable semi-sleeper seats with experienced drivers</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5" />
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Breakfast and lunch at quality restaurants</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5" />
                  ...
                  <div className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Monument Entry</h4>
                      <p className="text-sm text-gray-600">Taj Mahal entry fee included</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Camera charges at monuments</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <X className="w-5 h-5 text-red-600 mt-0.5" />
        ...
        {activeTab === "booking" && (
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Book Your Braj Yatra Tour</h2>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="border-t pt-2 flex justify-between">
                        ...
                        <span className="font-bold text-purple-600 text-xl">₹{1800 * passengers}</span>
                      </div>
                    </div>
                  </div>
